<template>
	<view>
		...
		<view class="discounts box">
			<view class="left">
				<view class="icon">
					<u-icon name="/static/center/packet.png" size="24"></u-icon>
				</view>
				<view class="title">
		...
		<view class="setting box">
			<view class="left">
				<view class="icon">
					<u-icon name="/static/center/setting-filling.png" size="24"></u-icon>
				</view>
				<view class="title">
		...
		<view class="telephone box">
			<view class="left">
				<view class="icon">
					<u-icon name="/static/center/telephone.png" size="24"></u-icon>
				</view>
				<view class="title">
		...
		<view class="opinions box">
			<view class="left">
				<view class="icon">
					<u-icon name="/static/center/fankui.png" size="24"></u-icon>
				</view>
				<view class="title">
		...
		<view class="register box" @click="show = true">
			<view class="left">
				<view class="icon">
					<u-icon name="/static/center/qishou.png" size="24"></u-icon>
				</view>
				<view class="title">
			...
			<u-popup :show="show" @close="close" @open="open">
				...
				<view class="bottom">
					<view class="auth">
						<view class="left">
							<view class="icon">
								<u-icon name="/static/login/芝麻-身份证.png" size="40"></u-icon>
							</view>
...
<script>
	...
	export default {
		...
		methods: {
			...
			register() {
				uni.navigateTo({
					url: '../login/registerRunering/registerRunerStep'
				})
			}
		},
		mounted() {
			// wx.request({
			// 	url: "https://maimai.ddindexs.com/user/demand",
			// 	method: "GET",
			// 	header: {
			...
			// 	success: (res) => {
			// 		console.log(res);
			// 		_this.$data.userName = res.data.data.userName
			// 	}
			// })
